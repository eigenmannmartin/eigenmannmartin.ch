    ...
    <div class="inner">
      <section class="wrapper">
        ...
        <p>
          ...
          <a href="https://github.com/eigenmannmartin/eigenmannmartin.ch">vue</a> and <span class="light-accent"><nuxt-link to="/experiments/TensorFlow">TensorFlow</nuxt-link></span>.
        </p>
        <p>
